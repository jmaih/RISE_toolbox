...
b g qs  ms  spinf sw kpf kp labobs robs pinfobs dy dc dinve dw
...
crhoa crhob crhog crhoqs crhoms crhopinf crhow ctrend cg
...
stochvol_tp_1_2, stochvol_tp_2_1

@parameters(stochvol,2) sig_a, sig_b,sig_w,sig_pinf,sig_m,sig_qs,sig_g
...
%	crhols,    0.9928;  % this parameter does not enter the model
	...
	stochvol_tp_1_2,     0.1,0.1,0.3,beta_pdf(.9);
	stochvol_tp_2_1,     0.2,0.2,0.5,beta_pdf(.9);
	sig_a(stochvol,1),   0.4618,0.01,2,inv_gamma_pdf(0.9);
	sig_a(stochvol,2),   0.4618,0.05,2.04,inv_gamma_pdf(0.9);
	sig_b(stochvol,1),   0.18185,0.01,2,inv_gamma_pdf(0.9);
	sig_b(stochvol,2),   0.18185,0.05,2.04,inv_gamma_pdf(0.9);
	sig_g(stochvol,1),   0.6090,0.01,2,inv_gamma_pdf(0.9);
	sig_g(stochvol,2),   0.6090,0.05,2.04,inv_gamma_pdf(0.9);
	sig_qs(stochvol,1),  0.46017,0.01,2,inv_gamma_pdf(0.9);
	sig_qs(stochvol,2),  0.46017,0.05,2.04,inv_gamma_pdf(0.9);
	sig_m(stochvol,1),   0.2397,0.01,2,inv_gamma_pdf(0.9);
	sig_m(stochvol,2),   0.2397,0.05,2.04,inv_gamma_pdf(0.9);
	sig_pinf(stochvol,1),0.1455,0.01,2,inv_gamma_pdf(0.9);
	sig_pinf(stochvol,2),0.1455,0.05,2.04,inv_gamma_pdf(0.9);
	sig_w(stochvol,1),   0.2089,0.01,2,inv_gamma_pdf(0.9);
	sig_w(stochvol,2),   0.2089,0.05,2.04,inv_gamma_pdf(0.9);
