...
% The solution stored in mfwz below assumes that the coefficient matrix on
% lead terms is known at time t
mfwz=solve(m,'solve_fwz_hypothesis',true);

% The default solution strategy does not make that assumption
m=solve(m);
