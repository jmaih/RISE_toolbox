...
pni(3)=pni(1).set('loglinearized',{pni(1).varendo.name});
...
data=load('gpr.dat');
data=ts('1948q2',data,char('ln_g','ln_pai','ln_r')); % <-- data=ts('1948q1',data,char('ln_g','ln_pai','ln_r'));
...
mm(2)=mm(1).set('estim_end_date','1979q4');
%   gt = gpr(128:220,1);
%   pt = gpr(128:220,2);
%   rt = gpr(128:220,3);

mm(3)=mm(1).set('estim_start_date','1980q1','estim_end_date','2003q1');
