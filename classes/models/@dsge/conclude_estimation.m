function [log_post,log_lik,log_prior,Incr,retcode,obj,x1,filtration]=conclude_estimation(obj,x1)
% INTERNAL FUNCTION
%
...
[log_post,log_lik,log_prior,Incr,retcode,obj,filtration]=log_posterior_kernel(obj,x1);
