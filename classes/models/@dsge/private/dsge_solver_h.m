    ...
    function [T,retcode]=solve_higher_orders(T,others,accelerate)
        ...
        if obj.options.solve_order>2 && ~retcode
            ...
            if obj.options.solve_order>3 && ~retcode
                ...
                Dzzzzz=fourth_order_rhs();
                [T.Tzzzz,retcode]=solve_generalized_sylvester(Dzzzzz,4);
                clear Dzzzz
        ...
        function Dzzzz=fourth_order_rhs()
            ...
            for r0=1:siz.h
                ...
                for r1=1:siz.h
                    ...
                    Dzzzz(:,:,r0)=Dzzzz(:,:,r0)+...
                        ...
                        dvv_Evz_vzzz()+...
                        dvv_Evzz_vzz()+...
                        others.dbf_plus{rt,rplus}*lambda_bf_XI01_4();
                end
                % precondition
            ...
            function res=dvvvv_Evz_vz_vz_vz()
                ...
                function res=something()
                    ...
                    matsizes=[size(a0_z);size(a0_z);size(a1_z);size(a1_z)];
                    %<--matsizes=[size(a0_z);size(a0_z);size(a1_z*u);size(a1_z*u)];
                    res=Pfunc(kronall(a0_z,a0_z,tmp),matsizes,...
            ...
            function res=lambda_bf_XI01_4()
                ...
                res=res+A_times_kron_Q1_Qk(T.Tzzz{r1}(pos.t.bf,:),Eu{2},hzz);
        ...
        function Dzzzzz=fifth_order_rhs()
            ...
            for r0=1:siz.h
                ...
                for r1=1:siz.h
                    ...
                    if test
                        tic,Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+dvvvvv_Evz_vz_vz_vz_vz();
                        disp(['dvvvvv_Evz_vz_vz_vz_vz: ',num2str(toc)])
                        
                        tic,Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+dvvvv_Evz_vz_vz_vzz();
                        disp(['dvvvv_Evz_vz_vz_vzz: ',num2str(toc)])
                        
                        tic,Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+dvvv_Evz_vz_vzzz();
                        disp(['dvvv_Evz_vz_vzzz: ',num2str(toc)])
                        
                        tic,Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+dvvv_Evz_vzz_vzz();
                        disp(['dvvv_Evz_vzz_vzz: ',num2str(toc)])
                        
                        tic,Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+dvv_Evz_vzzzz();
                        disp(['dvv_Evz_vzzzz: ',num2str(toc)])
                        
                        tic,Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+dvv_Evzz_vzzz();
                        disp(['dvv_Evzz_vzzz : ',num2str(toc)])
                        
                        tic,Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+others.dbf_plus{rt,rplus}*lambda_bf_XI01();
                        disp(['lambda_bf_XI01: ',num2str(toc)])
                    else
                        Dzzzzz(:,:,r0)=Dzzzzz(:,:,r0)+...
                            dvvvvv_Evz_vz_vz_vz_vz()+...
                            dvvvv_Evz_vz_vz_vzz()+...
                            dvvv_Evz_vz_vzzz()+...
                            dvvv_Evz_vzz_vzz()+...
                            dvv_Evz_vzzzz()+...
            ...
            function res=dvvvvv_Evz_vz_vz_vz_vz()
                ...
                res=res+structural_matrices.dvvvvv{r0,r1}*...
                    Pfunc(kronall(a0_z,a0_z,a0_z,...
                    kron_Q1_Qk_times_A(Eu{2},a1_z,a1_z)),...
                    ones(5,1)*[siz.nv,siz.nz],...[size(a0_z);size(a0_z);size(a0_z);size(a1_z);size(a1_z)],...
                    [1,2,4,3,5],[1,2,4,5,3],[1,4,2,5,3],...
                    [1,4,5,2,3],[4,1,5,2,3],[4,5,1,2,3],[4,1,2,5,3],...
                    [4,1,2,3,5],[1,4,2,3,5]);
                res=res+structural_matrices.dvvvvv{r0,r1}*Pfunc(kron(a0_z,kron_Q1_Qk_times_A(Eu{4},a1_z,a1_z,a1_z,a1_z)),...
                    [size(a0_z);size(a1_z);size(a1_z);size(a1_z);size(a1_z);],...
            ...
            function res=dvvvv_Evz_vz_vz_vzz()
                ...
                res=res+A_times_kron_Q1_Qk(...
                    ...
                    Pfunc(kron(Eu{4},hz),[size(Eu{3});siz.nz*ones(2,2)],[1,3,2]);
                res=res+A_times_kron_Q1_Qk(...
                    structural_matrices.dvvvv{r0,r1},...
                    Pfunc(kron(a0_z,kron_Q1_Qk_times_A(Eu{2},a1_z,a1_z)),...
                    [size(a0_z);size(a1_z);size(a1_z);],[2,1,3],[2,3,1]),...
                    a0_zz);
                res=res+structural_matrices.dvvvv{r0,r1}*(...
                    Pfunc(kronall(a0_z,a0_z,kron_Q1_Qk_times_A(...
                    Pfunc(kron(Eu{2},hz),siz.nz*ones(3,2),[1,3,2]),a1_z,a1_zz)),...
                    [size(a0_z);size(a0_z);size(a1_z);size(a1_zz)],...
                    [1,3,2,4],[3,1,2,4])+...
                    Pfunc(kron(a0_z,kron_Q1_Qk_times_A(Eu{4},a1_z,a1_z,a1_zz)),...
            ...
            function res=dvvv_Evz_vz_vzzz()
                res=A_times_kron_Q1_Qk(...
                    ...
                    a0_zzz+a1_zzz*Pfunc(kron(hz,Eu{2}),siz.nz*ones(3,2),...
                    [2,1,3],[2,3,1]));
                res=res+A_times_kron_Q1_Qk(...
                    structural_matrices.dvvv{r0,r1},...
                    kron_Q1_Qk_times_A(Eu{2},a1_z,a1_z),a0_zzz)+...
                    A_times_kron_Q1_Qk(structural_matrices.dvvv{r0,r1},...
                    a1_z,a1_z,a1_zzz)*Pfunc(kron(Eu{4},hz),...
                    [size(Eu{2});siz.nz*ones(3,2)],[1,2,4,3],[1,4,2,3]);
                res=res+structural_matrices.dvvv{r0,r1}*(...
                    Pfunc(kron(a0_z,kron_Q1_Qk_times_A(Pfunc(kronall(Eu{2},hz,hz),...
                    siz.nz*ones(4,2),[1,3,2,4],[1,3,4,2]),a1_z,a1_zzz)),...
                    [size(a0_z);size(a1_z);[siz.nv,siz.nz^3]],[2,1,3])+...
                    Pfunc(kron(a0_z,kron_Q1_Qk_times_A(Eu{4},a1_z,a1_zzz)),...
                    [size(a0_z);size(a1_z);[siz.nv,siz.nz^3]],[2,1,3])+...
                    Pfunc(kron(a0_z,dv_vz_omega(...
                    kron_Q1_Qk_times_A(kron(Eu{2},hzz),a1_z,a1_zz),...
                    siz.nz,2)),...
                    [size(a0_z);size(a1_z);[siz.nv,siz.nz^3]],[2,1,3])...
                    );
            end
            ...
            function res=dvvv_Evz_vzz_vzz()
                ...
                res=A_times_kron_Q1_Qk(...
                    ...
                    kron(a0_zz,a0_zz+a1_zz*Eu{2})+...
                    kron(a1_zz,a1_zz)*Pfunc(kronall(hz,Eu{2},hz),...
                    siz.nz*ones(4,2),[1,2,4,3],[2,1,4,3],[2,1,3,4])+...
                    kron(a1_zz*Eu{2},a0_zz)+...
                    kron_Q1_Qk_times_A(Eu{4},a1_zz,a1_zz));
                res=res+structural_matrices.dvvv{r0,r1}*(...
                    Pfunc(kron(kron(a1_z,a1_zz)*kron(Eu{2},hz),a0_zz),...
                    [size(a1_z);[siz.nv,siz.nz^2];size(a0_zz)],[1,3,2])+...
                    Pfunc(kronall(a1_z,a1_zz,a1_zz)*...
                    Pfunc(kron(hz,Eu{4}),siz.nz*ones(5,2),skip_first,...
                    [2,3,1,4,5],[2,1,3,4,5]),...
            ...
            function res=dvv_Evz_vzzzz()
                ...
                res=res+A_times_kron_Q1_Qk(...
                    ...
                    Pfunc(dv_vz_omega(kronall(Eu{2},hz,hzz),siz.nz,5),...
                    [siz.nz*ones(3,2);size(hzz)],[1,3,2,4]);
                res=res+dv_vz_omega(...
                    A_times_kron_Q1_Qk(...
            ...
            function res=dvv_Evzz_vzzz()
                ...
                res=res+A_times_kron_Q1_Qk(...
                    ...
                    [2,1,4,5,3])+...
                    Pfunc(kron(hz,Eu{4}),[siz.nz*ones(2,2);size(Eu{3})],...
                    [2,1,3])+...
                    Pfunc(kron(Eu{4},hz),[size(Eu{2});siz.nz*ones(3,2)],...
                    [1,2,4,3],[1,4,2,3]));
                res=res+A_times_kron_Q1_Qk(...
                    structural_matrices.dvv{r0,r1},a1_zz,a1_zz)*...
                    Pfunc(...
            ...
            function res=lambda_bf_XI01()
                res=dv_vz_omega(T.Tzzzz{r1}(pos.t.bf,:)*(...
                    kron(kronall(hz,hz,hz)+Pfunc(kron(Eu{2},hz),...
            ...
            function ATC_plus_T=afun(tau)
                ...
                function ATCzzz=temporary_term()
                    ...
                    elseif oo==4
                        ...
                        ATCzzz=ATCzzz+AT*Pfunc(kronall(hz,hz,Eu{2}),...
