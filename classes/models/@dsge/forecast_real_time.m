...
[filtration,~,~,retcode]=filter(obj,'kf_nsteps',nahead);
...
ts_fkst= filtration.rolling_multistep.Expected_filtered_variables;

ts_rmse= filtration.rolling_multistep.Expected_rmse;

rmse=double(ts_rmse);

Updates=filtration.Expected_updated_variables;
