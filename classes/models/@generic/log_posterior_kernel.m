function [log_post,log_lik,log_prior,Incr,retcode,obj,filtration]=log_posterior_kernel(obj,param)
...
if ~retcode
    ...
    [log_lik,Incr,retcode,obj,filtration]=likelihood_func(param,obj);
    ...
    if ~retcode(1) % pick the right retcode
        ...
        [log_prior(2),retcode(1)]=log_prior_density(obj,'endogenous',filtration);
