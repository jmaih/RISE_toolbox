...
linres.d=R1i_r_0(evec);

linres.K=R1i_R2_I2(evec,:);

linres.a2tilde_to_a=memoize_alpha(linres.d,linres.K);

linres.a_to_a2tilde=memoize_alpha2_tilde(ievec,na1);
...
function out=memoize_alpha2_tilde(ievec,na1)
