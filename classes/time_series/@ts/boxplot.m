...
% Make box plots of multiple time series in a frame
%
% ::
%
%    h = boxplot(db);
...
%    xrange (daterange): Range of the data to plot
%    varargin: options need to come in pairs
%
...
%      - 'labelorientation':
%
%          - 'horizontal' (default) for horizontal labels, or
...
%      - 'medianstyle':
%
%         - 'line' (default) to draw a line for the median, or
...
%      - 'outliersize': Size of marker used for outliers, in points. Default is 6.
...
%        - traditional: 'Median', 'Upper Whisker', 'Lower Whisker', 'Upper Adjacent Value', 'Lower Adjacent Value',
%        - compact:     'Whisker', 'MedianOuter', 'MedianInner'

%       when 'notch' is 'marker': 'NotchLo', 'NotchHi'
%
