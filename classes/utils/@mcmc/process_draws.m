function [d,fd,summary]=process_draws(draws,subset)
...
[d,fd,c,SIG,accept_ratio,last_saved_index,dlast,best]=mcmc.reload_draws(draws,subset);

[~,npop,nchains]=size(d);

summary=struct('nchains',nchains,'npop',npop,...
    'last_saved_index',last_saved_index,...
    'best_of_the_best',best,'last',dlast,...'estimated_cov',eSIG,'trimming',trimming,...
    'last_cov',SIG,...
    'last_cScale',c,...    
