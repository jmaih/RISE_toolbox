classdef table < rise_report.generic_report
    ...
    properties
        ...
        % user-defined function handles for formatting the table
        format_funcs={}
    ...
    methods
        ...
        function b = get.batch(obj)
            ...
            if ~isempty(obj.log)
                ...
                mylog=reprocess(obj.log);
                
                if ~iscell(obj.format_funcs)
                    
                    obj.format_funcs={obj.format_funcs};
                    
                end
                
                for ii=1:numel(obj.format_funcs)
                    
                    mylog=obj.format_funcs{ii}(mylog);
