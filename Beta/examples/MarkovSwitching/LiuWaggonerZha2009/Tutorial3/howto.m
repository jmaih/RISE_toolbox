...
shock_list={estim_models{1}.varexo.name};
shock_list_tex={estim_models{1}.varexo.tex_name};
var_list={'PAI','Y','I'}';
nvar=numel(var_list);
nshocks=numel(shock_list);
locs=locate_variables(var_list,{estim_models{1}.varendo.name});
var_list_tex={estim_models{1}.varendo(locs).tex_name};
