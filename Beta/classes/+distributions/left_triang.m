function varargout=left_triang(plb,pub,prob,~,~)
...
if hyperparameter_mode
    ...
    [ab,fval,retcode]=distributions.find_hyperparameters(space,cdfn,plb,pub,prob);
...
function [a,b]=moments_2_hyperparameters(m,s,~,~)
if s<=0
