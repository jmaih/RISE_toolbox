...
%    Other uses of le
%
%       adolm/le            handle/le              splanar/le
%       aplanar/le          mtree/le               string/le
%       categorical/le      qrandstream/le         sym/le
%       codistributed/le    RandStream/le          symbolic/le
%       datetime/le         rise_dates.dates/le    tabular/le
%       duration/le         rsymbdiff/le           ts/le
%       gpuArray/le
%