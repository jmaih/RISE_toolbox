                ...
                for ii=1:g.nvars
                    ...
                    if oo>1
                        ...
                        for jj=1:ii
                            ...
                            % this restriction might not be correct but is
                            % very likely 
                            if oo>2 && obj.dxx(1,ii,jj)~=0 
                                ...
                                for kk=1:jj
                                    ...
                                    % this restriction might not be correct
                                    % but is very likely
                                    if oo>3 && obj.dxxx(1,ii,jj,kk)~=0 
                                        ...
                                        for ll=1:kk
                                            ...
                                            do_fourth_order();
                                            % this restriction might not be
                                            % correct but is very likely
                                            if oo>4 && obj.dxxxx(1,ii,jj,kk,ll)~=0
    ...
    methods(Static)
        ...
        function C=diff(func,active,inactive,order)
            ...
            function arg_list=get_arg_list()
                ...
                right_par=find(fstr0==')',1,'first');
                
                fstr=fstr0(3:right_par-1);
