...
%       calendarDuration/max    gpuArray/max            tabular/max
%       categorical/max         rise_dates.dates/max    tall/max
%       codistributed/max       rsymbdiff/max           timeseries/max
%       datetime/max            splanar/max             ts/max
%