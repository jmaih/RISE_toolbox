...
%       calendarDuration/min    gpuArray/min            tabular/min
%       categorical/min         rise_dates.dates/min    tall/min
%       codistributed/min       rsymbdiff/min           timeseries/min
%       datetime/min            splanar/min             ts/min
%