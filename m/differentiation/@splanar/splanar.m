classdef splanar
    ...
    methods
        ...
        function obj=splanar(f,a)
            % Constructor for splanar objects
            %
            % ::
            %
            %   obj=splanar(f)
        ...
        function obj=betapdf(x,a,b)
            % overloads betapdf for splanar
            obj=do_trivariate(x,a,b,'betapdf');

        end

        function obj=cos(a)
            % overloads cos for splanar
            obj=do_univariate(a,'cos');

        end

        function obj=cosh(a)
            % overloads cosh for splanar
            obj=do_univariate(a,'cosh');

        end

        function obj=cot(a)
            % overloads cot for splanar
            obj=do_univariate(a,'cot');

        end

        function obj=eq(a,b)
            % overloads eq for splanar
            obj=do_bivariate(a,b,'eq');

        end

        function obj=erf(a)
            % overloads erf for splanar
            obj=do_univariate(a,'erf');

        end

        function obj=exp(a)
            % overloads exp for splanar
        ...
        function obj=gt(a,b)
            % overloads ge for splanar
            obj=do_bivariate(a,b,'gt');

        end

        function obj=if_elseif(varargin)
            % overloads if_elseif for splanar
            n=nargin;
        ...
        function obj=if_then_else(a,b,c)
            % overloads if_then_else for splanar
            obj=if_elseif(a,b,~a,c);

        end

        function obj=le(a,b)
            % overloads le for splanar
            obj=do_bivariate(a,b,'le');

        end

        function obj=log(a)
            % overloads log for splanar
        ...
        function obj=ne(a,b)
            % overloads ne for splanar
            obj=do_bivariate(a,b,'ne');

        end

        function obj=norminv(x,mu,sd)
            % overloads normcdf for splanar
            if nargin<3
        ...
        function obj=or(a,b)
            % overloads or for splanar
            obj=do_bivariate(a,b,'or');

        end

        function obj=plus(a,b)
            % overloads plus for splanar
            [a,b]=splanarize(a,b);
