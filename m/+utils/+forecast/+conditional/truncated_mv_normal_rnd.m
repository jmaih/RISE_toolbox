function x=truncated_mv_normal_rnd(mu,SIG,lb,ub,Nsim,method,seed)
% x=truncated_mv_normal_rnd(mu,SIG,lb,ub)
% x=truncated_mv_normal_rnd(mu,SIG,lb,ub,Nsim)
% x=truncated_mv_normal_rnd(mu,SIG,lb,ub,Nsim,'ghk')
