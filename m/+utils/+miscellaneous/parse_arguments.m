...
if size(args,2)==4
    ...
    assert(iscellstr(error_msg),'fourth column of first input must be a cellstr') %#ok<ISCLSTR>
...
assert(iscellstr(arg_names),'first column of first input must be a cellstr') %#ok<ISCLSTR>
