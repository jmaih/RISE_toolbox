function varargout=weibull(lowerquantileORmean,upperquantileORstdev,prob,c,d)
% INTERNAL FUNCTION: weibull distribution
%
% Note:
...
[ab,fval]=fsolve(@objective,rand(2,1),optimset('display','off'),c,d,m,s);
fval=norm(fval);
a=ab(1);
b=ab(2);
