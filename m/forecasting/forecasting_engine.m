function [CYf,CYfMean,Yf,Emean,E]=forecasting_engine(Y0,H,G,EndogenousConditions,...
...
[PbParams,M1,M2,RM2i,OMG,DYbar,UU,SS,Yf,MU,LB,UB]=ConditionalProjectionSubEngine(Hypothesis,Nsteps,H,G,Y0,...
...
CYfMean=InitializeArray(@zeros,PbParams.endo_nbr,PbParams.MaxIter,1,Y0);
CYfMean=ComputeForecasts(CYfMean,H,G,Emean,Nsteps,PbParams.NumberOfAnticipatedPeriods);

seed=[];
r=TruncatedMultivariateNormalRnd(rstar,OMG,rlow,rhigh,NumberOfSimulations,method,seed);
% draw gam2
gam2=RM2i*r;
clear r
% draw gam1
...
CYf=InitializeArray(@zeros,PbParams.endo_nbr,PbParams.MaxIter,NumberOfSimulations,Y0);
