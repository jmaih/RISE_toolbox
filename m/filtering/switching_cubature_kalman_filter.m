function [loglik,Incr,retcode,Filters]=switching_cubature_kalman_filter(...
syst,data_y,U,z,options)
% INTERNAL FUNCTION: filter for nonlinear regime-swiching models
%
% ::
%
...
w=utils.filtering.sigma_weights(mm,'ckf');
