...
%   etc.
%
%   [X,F,exitflag,H] = BEE_GATE(...) returns, in addition to X, F, and
%   exitflag, and estimate (H) of the hessian
%
%   [X,F,exitflag,H,OBJ] = BEE_GATE(...) returns, in addition to X,F, H and
