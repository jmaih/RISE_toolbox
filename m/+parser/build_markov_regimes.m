...
transition_matrices,markov_chains,issorted,transmat_perturb_coef)
% INTERNAL FUNCTION
%

if nargin<4
    
    transmat_perturb_coef=[];
...
TM=parser.apply_perturbation_to_transition_matrix(TM,transmat_perturb_coef);
