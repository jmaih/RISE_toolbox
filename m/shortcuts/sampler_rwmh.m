%  sampler_rwmh : Shortcut to Random-walk Metropolis-Hastings algorithm
% 
%  The syntax is ::
% 
%  	results = sampler_rwmh(target,x0,lb,ub)
% 
%  	results = sampler_rwmh(target,x0,lb,ub,opts)
% 
%  INPUTS :
% 
%    - *target* : objective to MINIMIZE (Unlike in rsamplers.sampler_rwmh)
