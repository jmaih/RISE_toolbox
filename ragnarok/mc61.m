...
if strcmpi(info,'LastCall')
    ...
    if options.nclimb
        ...
        msg='Now I am climbing the hill... ';
        
        [ModePar,mlogpo2,iScale]=looper(msg,nsim,ModePar,mlogpo2,iScale);
...
PostMod = ModePar;
    ...
    function [ModePar,mlogpo2,iScale]=looper(msg,nsim,ModePar,mlogpo2,iScale)
