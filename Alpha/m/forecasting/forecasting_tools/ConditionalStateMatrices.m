function [Tt,Rt,bt,Qt,Record]=ConditionalStateMatrices(T,R,mut,OMG,DPHI,DT,Record,ExpandedFlag)
...
[mut,DPHI,DT,OMG]=RemoveHoles(mut(:),DPHI,DT,{OMG});

if ~isempty(Record) && isequal(Record{1},DPHI)
	M1=Record{2};
else
	[M1,M2,RM2i]=NullAndColumnSpaces(DPHI);
