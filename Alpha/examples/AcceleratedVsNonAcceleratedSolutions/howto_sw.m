...
sw_com=sw_com.set('parameters',struct('name','ProbabilityOfCommitment','value',1));
...
sw_discr=sw_com;
sw_discr(1)=sw_discr(1).set('parameters',struct('ProbabilityOfCommitment',0));

sw_discr(2)=sw_discr(2).set('parameters',struct('ProbabilityOfCommitment',0));
