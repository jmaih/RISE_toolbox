...
t0a=rise_time_series.empty(0,1);
 % or simply
t0b=rise_time_series;
...
v1a=rise_time_series(1990,RM(:,1));
v1b=rise_time_series('1990',RM(:,1));

% at bi-annual frequency
v2=rise_time_series('1990H1',RM(:,2));

% at quarterly frequency
v3=rise_time_series('1990Q1',RM(:,3));

% at monthly frequency
v4=rise_time_series('1990M1',RM(:,4));

% at weekly frequency: 2 options
v5a=rise_time_series('1990M1D5W',RM(:,5));
v5b=rise_time_series('19900105W',RM(:,5));

% at daily frequency: 2 options
v6a=rise_time_series('1990M1D1',RM(:,6));
v6b=rise_time_series('19900101D',RM(:,6));
...
v1d=rise_time_series(v1c.TimeInfo,annual_data,{'current','lags','leads'})
...
collection=rise_time_series.collect({'v1',v1a},{'v2',v2},{'v3',v3},{'v4',v4},{'v5',v5a},{'v6',v6a});
