...
if solve_expect_order>1 
    error('RISE does not currently up to a 2nd order models in which agents anticipate the future')
end
        ...
        for s00=1:h
            ...
            for s11=1:h
                ...
                Desig=Desig+...
                    ...
                    A_times_kron_B_I(syst_mat.Gep{s00,s11},mxmsms,exo_nbr)+...syst_mat.Gep{s00,s11}*kron(mxmsms,Ie)+...
                    A_times_kron_B_I(syst_mat.Gec{s00,s11},obj.solution.m_sig{s00},exo_nbr)+...syst_mat.Gec{s00,s11}*kron(obj.solution.m_sig{s00},Ie)+...
                    A_times_kron_B_I(syst_mat.Get{s00,s11},obj.solution.theta_hat{s11},exo_nbr);%syst_mat.Get{s00,s11}*kron(obj.solution.theta_hat{s11},Ie);
            end
        ...
        for s00=1:h
            ...
            for s11=1:h
                ...
                Dee=Dee+...
                    ...
                    A_times_kron_I_B(syst_mat.Gpe{s00,s11},mxe10,exo_nbr)+...syst_mat.Gpe{s00,s11}*kron(Ie,mxe10)+...
                    ...
                    A_times_kron_I_B(syst_mat.Gce{s00,s11},obj.solution.m_e{s00},exo_nbr)+...syst_mat.Gce{s00,s11}*kron(Ie,obj.solution.m_e{s00})+...
                    A_times_kron_B_I(syst_mat.Gep{s00,s11},mxe10,exo_nbr)+...syst_mat.Gep{s00,s11}*kron(mxe10,Ie)+...
                    A_times_kron_B_I(syst_mat.Gec{s00,s11},obj.solution.m_e{s00},exo_nbr)+...syst_mat.Gec{s00,s11}*kron(obj.solution.m_e{s00},Ie)+...
        ...
        for s00=1:h
            ...
            for s11=1:h
                ...
                Dxsig=Dxsig+...
                    ...
                    A_times_kron_B_I(syst_mat.Gmp{s00,s11},mx1s0,endo_nbr)+...syst_mat.Gmp{s00,s11}*kron(mx1s0,Ix)+...
                    A_times_kron_B_I(syst_mat.Gmp{s00,s11},obj.solution.m_sig{s11},endo_nbr)+...syst_mat.Gmp{s00,s11}*kron(obj.solution.m_sig{s11},Ix)+...
                    A_times_kron_B_I(syst_mat.Gmc{s00,s11},obj.solution.m_sig{s00},endo_nbr);%syst_mat.Gmc{s00,s11}*kron(obj.solution.m_sig{s00},Ix);
            end
        ...
        for s00=1:h
            ...
            for s11=1:h
                ...
                Dxe=Dxe+...
                    ...
                    A_times_kron_I_B(syst_mat.Gpm{s00,s11},mx1e0,endo_nbr)+...syst_mat.Gpm{s00,s11}*kron(Ix,mx1e0)+...
                    ...
                    A_times_kron_I_B(syst_mat.Gcm{s00,s11},obj.solution.m_e{s00},endo_nbr)+...syst_mat.Gcm{s00,s11}*kron(Ix,obj.solution.m_e{s00})+...
                    A_times_kron_B_I(syst_mat.Gep{s00,s11},mx1x0,exo_nbr)+...syst_mat.Gep{s00,s11}*kron(mx1x0,Ie)+...
                    A_times_kron_B_I(syst_mat.Gec{s00,s11},obj.solution.m_x{s00},exo_nbr)+...syst_mat.Gec{s00,s11}*kron(obj.solution.m_x{s00},Ie)+...
...
% % % %                     A_times_kron_I_B(syst_mat.Gpe{s00,s11},mx1x0,exo_nbr)+...syst_mat.Gpe{s00,s11}*kron(Ie,mx1x0)+...
...
% % % %                     A_times_kron_I_B(syst_mat.Gce{s00,s11},obj.solution.m_x{s00},exo_nbr)+...syst_mat.Gce{s00,s11}*kron(Ie,obj.solution.m_x{s00})+...
% % % %                     A_times_kron_B_I(syst_mat.Gmp{s00,s11},obj.solution.m_x{s11}*obj.solution.m_e{s00},endo_nbr)+...syst_mat.Gmp{s00,s11}*kron(obj.solution.m_x{s11}*obj.solution.m_e{s00},Ix)+...
% % % %                     A_times_kron_B_I(syst_mat.Gmc{s00,s11},obj.solution.m_e{s00},endo_nbr)+...syst_mat.Gmc{s00,s11}*kron(obj.solution.m_e{s00},Ix)+...
    ...
    function [Dxx_bar,AB]=routine_mxx()
        ...
        for s00=1:h
            ...
            for s11=1:h
                ...
                Dxx_bar(:,:,s00)=Dxx_bar(:,:,s00)+A_times_k_kron_B(syst_mat.Gpp{s00,s11},mx1x0,2)+...syst_mat.Gpp{s00,s11}*kron(mx1x0,mx1x0)+...
                    syst_mat.Gpc{s00,s11}*kron(m_x{s00},mx1x0)+...
                    A_times_kron_I_B(syst_mat.Gpm{s00,s11},mx1x0,endo_nbr)+...syst_mat.Gpm{s00,s11}*kron(Ix,mx1x0)+... 
                    syst_mat.Gcp{s00,s11}*kron(mx1x0,m_x{s00})+...
                    syst_mat.Gcc{s00,s11}*mx0x0{s00}+...
                    A_times_kron_I_B(syst_mat.Gcm{s00,s11},m_x{s00},endo_nbr)+...syst_mat.Gcm{s00,s11}*kron(Ix,m_x{s00})+...
                    A_times_kron_B_I(syst_mat.Gmp{s00,s11},mx1x0,endo_nbr)+...syst_mat.Gmp{s00,s11}*kron(mx1x0,Ix)+...
                    A_times_kron_B_I(syst_mat.Gmc{s00,s11},m_x{s00},endo_nbr)+... syst_mat.Gmc{s00,s11}*kron(m_x{s00},Ix)+...
